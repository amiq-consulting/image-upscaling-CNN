...
set_top bicubic
add_files bicubic.cpp -cflags "-D__XFCV_HLS_MODE__ --std=c++11 -IC:/xfopencv-master/include"
add_files interpolation_kernel.cpp -cflags "-D__XFCV_HLS_MODE__ --std=c++11 -IC:/xfopencv-master/include"
